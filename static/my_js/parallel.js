...
// Defines the size of the table_chart
var m = [90, 0, 10, 0], 		 
    w = width - m[1] - m[3],
    h = height - m[0] - m[2],
...
//Let's define the colors of the groups
var colors = {
    "Component 1": [20,200,32],
    "Component 2": [37,50,75],
    "Component 3": [325,50,39],
    "Component 4": [325,50,39],
    "Component 5": [325,50,39],
    "Component 6": [325,50,39],
    "Fats and Oils": [30,100,73],
    "Vegetables and Vegetable Products": [120,56,40]
};

// Scale table_chart and canvas height
d3.select("#table_chart")
