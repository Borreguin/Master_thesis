...
if(start_time == null){
    start_time = new Date('2013-01-10');
}
if(end_time == null){
    end_time = new Date('2013-12-21');
}

var width_menu_part = document.getElementById('variable_category_buttons').clientWidth;

var width = document.body.clientWidth - width_menu_part,
    height = d3.max([document.body.clientHeight-540, 240]);

// Defines the size of the chart
var m = [50, 10, 10, 0],  //up, right, down, left (only positive values)
    w = width - m[1] - m[3],
    h = height - m[0] - m[2],
...
var data_url = '/data_hmm'+ "?list_projection=" + list_projection + "&start_time=" + start_time.toISOString()
